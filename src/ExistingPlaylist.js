  ...
  render() {
    ...
    return (
      <div classname="ep-container">
        ...
        <form>
          <label id="label">
            enter your spotify-associated email then a comma then a space then your friend's spotify-associated email. (if this doesn't work, try switching the order!)
